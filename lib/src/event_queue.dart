...
// class _PriorityTask<T> extends TaskBase<T> implements Comparable<_PriorityTask> {
...
// class _PriorityQueueProxy<T extends TaskBase> extends HeapPriorityQueue<T> implements QueueProxy<T> {
